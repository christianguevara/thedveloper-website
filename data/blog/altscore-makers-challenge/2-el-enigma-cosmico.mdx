...
draft: false
summary: 'A solution to the second AltScore programming challenge where we solve a cosmic puzzle by calculating the average resonance of stars in a nebula. The challenge involves working with a paginated API endpoint, analyzing response headers, and implementing an automated solution to process 100 stars across 34 pages.'
---

**TLDR:** [Script](https://github.com/christianguevara/thedveloper-website/blob/main/data/blog/altscore-makers-challenge/2-get_average_resonance.mjs)
...
$$
Total pages = \left\lceil \frac{100}{3} \right\rceil
$$

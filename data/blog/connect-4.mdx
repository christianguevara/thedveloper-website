...
To check the 4 cases above there are also many ways to do it:
...
From the options above, the **third option** is the most _efficient_. For sure, there are more ways to do it, but for now, I think the third option is enough.
...
Extra code not included in this article was added because of validations and readability. But I do think the core part is covered.
